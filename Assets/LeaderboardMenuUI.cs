...
*/
        ...
        public WakawakaConnection _connection;
        ...
        /// </summary>
        public void Init(WakawakaConnection connection)//, ProfilePopup profilePopup)
        {
        ...
        public async void ShowGlobalLeaderboards(string cursor = null)
        {
            ...
            Debug.Log(_connection.SingletonSession);
            IApiLeaderboardRecordList records = await _connection.Client.ListLeaderboardRecordsAsync(_connection.SingletonSession, "global", ownerIds: null, expiry: null, _recordsPerPage, cursor);
            Debug.Log(records);
        ...
        {
            Debug.Log("ready to fill the board");
            ...
            {
                Debug.Log("ready to instantiate");
